...
class Oscillator {
    constructor(x_0 = 0, v_0 = 0, spring_constant = 1, A = 1, Drag = t => 0, drivingForce = t => 0, mass = 1, C = t => 0, n = 0, iteration = 1) {
        this.x_h = [x_0];
        this.v_h = [v_0];
